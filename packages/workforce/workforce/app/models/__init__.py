...
This file only exposes package models when the environment variable WORKFORCE_EXPOSE_PACKAGE_MODELS
is set to a truthy value. This prevents duplicate SQLAlchemy Table registrations when the canonical
apps/api app imports its own models.
"""
import os
